...
const DoctorFormDialog = ({
    ...
    useEffect(() => {
        if (state && !toastShownRef.current) {
            if (state?.success) {
                toast.success(state.message || 'Doctor saved successfully');
                toastShownRef.current = true;
                onSuccess();
                onClose();
            } else if (!state.success) {
                toast.error(state.message || 'Failed to save doctor');
                toastShownRef.current = true;
            }
        }
            ...
            <DialogContent className='max-h-[90vh] flex flex-col p-0'>
                ...
                >
                    <div className='flex-1 overflow-y-auto px-6 space-y-4 pb-4'>
                        ...
                        <Field>
                            <FieldLabel htmlFor='specialities'>
                                Speciality
                            </FieldLabel>
                            <Input
                                id='specialities'
                        ...
                        <Field>
                            ...
                            <Input
                                ...
                                defaultValue={
                                    isEdit ? doctor?.address : undefined
                                }
                            />
                        ...
                        <Field>
                            ...
                            <Input
                                ...
                                placeholder='5'
                                defaultValue={
                                    isEdit ? doctor?.experience : undefined
                                }
                                min='0'
                            />
                        ...
                        <Field>
                            ...
                            <Input
                                ...
                                placeholder='100'
                                defaultValue={
                                    isEdit ? doctor?.appointmentFee : undefined
                                }
                                min='0'
                            />
                            <InputFieldError
                        ...
                        <Field>
                            ...
                            <Input
                                ...
                                placeholder='MBBS, MD'
                                defaultValue={
                                    isEdit ? doctor?.qualification : undefined
                                }
                            />
                            <InputFieldError
                                state={state}
                        ...
                        <Field>
                            ...
                            <Input
                                ...
                                defaultValue={
                                    isEdit ? doctor?.designation : undefined
                                }
                            />
                            <InputFieldError
                                state={state}
